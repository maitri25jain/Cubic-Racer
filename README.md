...
* **Collision Detection:** Scripted logic to identify obstacle collisions, triggering game-over states and level reloads.
* **Game State Management:** Implemented a core game loop to manage scene transitions, win/loss conditions, and automated resetting.
* **User Interface:** Developed a responsive canvas UI to display real-time scoring and level completion screens.
